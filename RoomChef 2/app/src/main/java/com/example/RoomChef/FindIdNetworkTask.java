...
public class FindIdNetworkTask extends AsyncTask<Integer, String , Object> {
    Context context;
    String mAddr;
    ProgressDialog progressDialog;
    String returnPhone;

    public FindIdNetworkTask(Context context, String mAddr) {
...
//        progressDialog.dismiss();
    ...
    protected Object doInBackground(Integer... integers) {
        ...
        return returnPhone; // 패스워드 리턴시키고 엑티비티에서 받음
    }
    private void Parser(String s){
        try {
            JSONObject jsonObject = new JSONObject(s);
            returnPhone = jsonObject.getString("phone"); // 디비에서 패스워드 받아옴
            Log.v("디비 phone",returnPhone);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
